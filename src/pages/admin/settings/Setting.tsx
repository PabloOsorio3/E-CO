...
const Setting: React.FC = () => {
    ...
    const settings = [
        { title: 'Categorías', subtitle: 'Gestionar categorías de productos', color: 'primary', icon: fileTrayFull, url: '/admin/settings-category' },
        { title: 'Subcategorías', subtitle: 'Gestionar subcategorías de productos', color: 'tertiary', icon: fileTrayStacked, url: '/admin/settings-subcategory' },
